...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[GetImage imagesNamedFromCustomBundle:@"anqu_checkbox_choose"] forState:UIControlStateNormal];
        [self setImage:[GetImage imagesNamedFromCustomBundle:@"anqu_checkbox_unchoose"] forState:UIControlStateSelected];
